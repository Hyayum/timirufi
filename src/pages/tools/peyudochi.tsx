...
const defaultOptionsBase: LetterOption[] = [
  ...
  { letter: "ぢゅぁ", weight: 1, minor: true },
  ...
  { letter: "づゃ", weight: 1, afterTu: 1, minor: true },
  { letter: "づゅ", weight: 1, afterTu: 1, minor: true },
  { letter: "づぃぇ", weight: 0.5, afterTu: 0.5, minor: true },
  { letter: "づょ", weight: 1, afterTu: 1, minor: true },
  { letter: "づぅぁ", weight: 1, afterTu: 1, minor: true },
  ...
  { letter: "ほぁ", weight: 1, afterN: 1, afterTu: 1, minor: true },
  { letter: "ほぃ", weight: 1, afterN: 1, afterTu: 1, minor: true },
  { letter: "ほぇ", weight: 1, afterN: 1, afterTu: 1, minor: true },
  { letter: "ほぅぉ", weight: 1, afterN: 1, afterTu: 1, minor: true },
  { letter: "ぱ", weight: 5 },
  { letter: "ぴ", weight: 5 },
  { letter: "ぷ", weight: 4 },
  { letter: "ぺ", weight: 4 },
  ...
  { letter: "びぇ", weight: 1, afterTu: 1, minor: true },
